...
PHONE_GUIDANCE = (
    ...
    "keyboard's Go or Search; open Filters, scroll the list, tap Sort by), send them as one phone_do. "
    "After typing into a search or text field, press enter to submit it, unless a suggestion shown is "
