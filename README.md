...
![tests](https://img.shields.io/badge/tests-1591%20passed-brightgreen)
...
| [tests](tests/README.md) | 1,591 tests that need no key and no network |
...
1,591 tests pass and 12 skip on macOS, Linux and Windows in under two minutes,
